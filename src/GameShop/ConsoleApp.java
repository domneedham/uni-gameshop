...
public class ConsoleApp {
    public static void main(String[] args) {
        ...
        Console console = new Console("Nintendo DS", ConsoleForm.HANDHELD, 15, 8);
        Console console1 = new Console("Xbox One", ConsoleForm.STANDARD, 15, 256);
        Game gta = new Game("Grand Theft Auto 5", console, 5);
        Game dota = new Game("Dota 2", console, 10);
        Game creed = new Game("Assassins Creed", console, 15);
        Game cod = new Game("Call of Duty", console, 5);
